...
Alle Permissions gehören zu einer Permission group.
Beim Anfordern einer Dangerous Permission, wird nicht die Permission, sondern die jeweilige Permission group angezeigt. \newline
So zeigt sowohl eine Anforderung der READ\_CONTACTS Permission, als auch der WRITE\_CONTACTS Permission an, dass Zugriff auf die Kontakte des Geräts benötigt werden.
Wenn die App eine Dangerous Permission anfordert und die App bereits eine andere Dangerous Permission in dieser Gruppe besitzt, wird die Anfrage automatisch bestätigt.
Alle Permissions können zu einer Permission group gehören, allerdings sind nur Permission groups von Dangerous Permissions relevant für Benutzer und Entwickler.
