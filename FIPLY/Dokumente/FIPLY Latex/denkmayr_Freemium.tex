...
\begin{document}
\subsection{Freemium}
Beim Nachforschen und beim Implementieren von Freemium wurden diese Quellen verwendet: [\citetitle{yFreemium} \cite{yFreemium}], [\citetitle{adAdministerBilling} \cite{adAdministerBilling}]. \newline
