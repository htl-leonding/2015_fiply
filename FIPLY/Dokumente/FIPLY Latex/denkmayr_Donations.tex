...
\end{quote}\cite{flattr} \citetitle{flattr}
...
\end{quote}\cite{gpDevContentPolicy} \citetitle{gpDevContentPolicy}
...
\end{quote}\cite{gpInAppBilling} \citetitle{gpInAppBilling}
