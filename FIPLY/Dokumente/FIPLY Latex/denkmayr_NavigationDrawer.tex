...
Beim Nachforschen und beim Erstellen des NavigationDrawers wurden die Blogs [\citetitle{bNavDrawer} \cite{bNavDrawer}], [\citetitle{bNavDrawerRT} \cite{bNavDrawerRT}] und die Anleitung zu NavigationDrawers [\citetitle{adNavDrawer} \cite{adNavDrawer}] verwendet. 
