...
\begin{document}
\section{Musik}
Beim erstellen des MediaPlayers wurden diese Quellen verwendet: [\citetitle{adMediaPlayer} \cite{adMediaPlayer}], [\citetitle{bMediaPlayer} \cite{bMediaPlayer}]. % Quellen
