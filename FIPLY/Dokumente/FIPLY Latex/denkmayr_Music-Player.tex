...
\item Der Musikmodus Button stellt den aktuellen Modus durch Einfärbung des Buttons dar und ermöglicht einen Wechsel zwischen dem Übungsmodus und dem Musikmodus. \newline
